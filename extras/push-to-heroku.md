...
Clearly 'http://blazing-comet-99814.herokuapp.com' is not the most user friendly URL. Not surprisingly, heroku allows you to rename the prefix (you can also use [custom domain](https://devcenter.heroku.com/articles/custom-domains) names if you get very serious about your app).
...
If you want to delve further into Heroku, let me tell you that if you run a database powered webapp, Heroku will really shine. It makes deployment and maintenance of your DB a much simpler affair. DB development is a whole nex chapter, but with Heroku you will be surprised by how quickly you'll be able to run your webapp with a DB in the backend. I encourage you to read the Heroku's [doc](https://devcenter.heroku.com/categories/heroku-postgres) on the subject to wet your appetite. And while Heroku is very much a Postgresql centered service, there are a number of other options available, though nor always free (unlike the Postrgesl basic plan which is free!)
